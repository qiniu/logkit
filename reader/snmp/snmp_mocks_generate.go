...
var mockedCommands = [][]string{
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".1.0.0.0"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".1.0.0.1.1"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".1.0.0.1.2"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", "1.0.0.1.1"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".1.0.0.0.1.1"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".1.0.0.0.1.1.0"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".1.0.0.0.1.4"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".1.2.3"},
	{"snmptranslate", "-Td", "-Ob", ".iso.2.3"},
	{"snmptranslate", "-Td", "-Ob", "-m", "builtin", ".999"},
